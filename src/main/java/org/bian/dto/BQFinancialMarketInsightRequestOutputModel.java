...
/**
 * BQFinancialMarketInsightRequestOutputModel
 */
public class BQFinancialMarketInsightRequestOutputModel   {
  ...
  private String financialMarketInsightRequestActionTaskReference = null;

  private Object financialMarketInsightRequestActionTaskRecord = null;

  private String financialMarketInsightRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Financial Market Insight instance request service call 
   * @return financialMarketInsightRequestActionTaskReference
  **/

  public String getFinancialMarketInsightRequestActionTaskReference() {
    return financialMarketInsightRequestActionTaskReference;
  }

  public void setFinancialMarketInsightRequestActionTaskReference(String financialMarketInsightRequestActionTaskReference) {
    this.financialMarketInsightRequestActionTaskReference = financialMarketInsightRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return financialMarketInsightRequestActionTaskRecord
  **/

  public Object getFinancialMarketInsightRequestActionTaskRecord() {
    return financialMarketInsightRequestActionTaskRecord;
  }

  public void setFinancialMarketInsightRequestActionTaskRecord(Object financialMarketInsightRequestActionTaskRecord) {
    this.financialMarketInsightRequestActionTaskRecord = financialMarketInsightRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Financial Market Insight service request record 
   * @return financialMarketInsightRequestRecordReference
  **/

  public String getFinancialMarketInsightRequestRecordReference() {
    return financialMarketInsightRequestRecordReference;
  }

  public void setFinancialMarketInsightRequestRecordReference(String financialMarketInsightRequestRecordReference) {
    this.financialMarketInsightRequestRecordReference = financialMarketInsightRequestRecordReference;
  }
